...
/**
 * Generated from protobuf message <code>toit.api.RunStartRequest</code>
 */
class RunStartRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $sdk_name = '';
    /**
     * Generated from protobuf field <code>string entry_filename = 2 [deprecated = true];</code>
     * @deprecated
     */
    protected $entry_filename = '';
    /**
     * Generated from protobuf field <code>map<string, bytes> sources = 3 [deprecated = true];</code>
     * @deprecated
     */
    private $sources;
    /**
    ...
    private $args;
    /**
     * Generated from protobuf field <code>.toit.api.ProgramSource source = 5;</code>
     */

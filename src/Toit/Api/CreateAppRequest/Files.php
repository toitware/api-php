...
namespace Toit\Api\CreateAppRequest;
...
/**
 * Generated from protobuf message <code>toit.api.CreateAppRequest.Files</code>
 */
...
class_alias(Files::class, \Toit\Api\CreateAppRequest_Files::class);

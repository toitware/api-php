...
/**
 * Generated from protobuf message <code>toit.api.ConfigChange.LoggingLevel</code>
 */
class LoggingLevel extends \Google\Protobuf\Internal\Message
{
    /**
...
class_alias(LoggingLevel::class, \Toit\Api\ConfigChange_LoggingLevel::class);
